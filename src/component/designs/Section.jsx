...
const Section = ({
  ...
  return (
    <div id={id} className={`relative px-[3rem] max-md:px-[2rem] max-lg:mt-4 flex flex-col items-center text-start -z-1 py-10 lg:py-16 xl:py-20 ${className || ''}  ${ light ? 'bg-n-1/20' : ''} `} style={style}>
